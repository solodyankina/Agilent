...
//----------------------------------------------------------------------------------
		...
		if (SaveDialog1->Execute())
		{
			...
			str = "C:\\Documents and Settings\\Администратор\\Рабочий стол\\TestOscil_norm\\report\\err_data.html";
		f.open("C:\\Documents and Settings\\Администратор\\Рабочий стол\\TestOscil_norm\\report\\err_data.html");
		...
		ShellExecute(0, "open", "C:\\Documents and Settings\\Администратор\\Рабочий стол\\TestOscil_norm\\report\\err_data.html", NULL, NULL, SW_RESTORE);
	}
	}
	viClose (vi);
	viClose (defaultRM);
