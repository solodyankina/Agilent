...
typedef ViStatus _VI_FUNC  (*fviOpenDefaultRM) (ViPSession vi);
...
typedef ViStatus _VI_FUNC  (*fviOpen)(ViSession sesn, ViRsrc name, ViAccessMode mode,
                                    ViUInt32 timeout, ViPSession vi);

/*- Resource Template Operations --------------------------------------------*/

typedef ViStatus _VI_FUNC  (* fviClose)(ViObject vi);
...
typedef ViStatus _VI_FUNC  (*fviRead)(ViSession vi, ViPBuf buf, ViUInt32 cnt, ViPUInt32 retCnt);
...
ViStatus _VI_FUNC  viReadToFile    (ViSession vi, ViConstString filename, ViUInt32 cnt,
									ViPUInt32 retCnt);
typedef ViStatus _VI_FUNC  (*fviWrite)(ViSession vi, ViBuf  buf, ViUInt32 cnt, ViPUInt32 retCnt);
...
typedef ViStatus _VI_FUNCC (* fviPrintf )(ViSession vi, ViString writeFmt, ...);
...
ViStatus _VI_FUNC  viVSPrintf      (ViSession vi, ViPBuf buf, ViString writeFmt,
									ViVAList parms);
typedef ViStatus _VI_FUNCC (* fviScanf)(ViSession vi, ViString readFmt, ...);
